...
recon = stir.OSMAPOSLReconstruction3DFloat('recon_demo_OSEM_SPECTGPU.par')
...
projdata=recon.get_input_data()#recon.tir.ProjData.read_from_file('smalllong.hs');
# use smaller voxels than the default
# zoom=2.216842;
target=recon.get_initial_data() #stir.FloatVoxelsOnCartesianGrid(projdata.get_proj_data_info(), zoom);
# get initial image
# help(target)
